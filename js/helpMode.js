...
(function ($, window, document, undefined) {
    ...
    var pluginName = 'helpMode',
        ...
        _layout: function () {
            ...
            t.positionWrap = t._getPosition({top: 0, left: 0}, -t.wrap.outerWidth(true), -t.wrap.outerHeight(true), t.dataOptions.childAlign);
       ...
       // get top center position
        ...
        show: function () {
            ...
            if (t.options.delayShow === 0) {
                ...
                setTimeout( function() { t._showPlugin(); }, t.options.delayShow );
            }
        ...
        hide: function () {
            ...
            if (t.options.delayHide === 0) {
                ...
                setTimeout( function() { t._hidePlugin(); }, t.options.delayHide );
            }
